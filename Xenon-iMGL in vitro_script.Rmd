...
top100genes <- sigDEcounts %>% head(n = 100)
genheatmap(top100genes, colnames(top100genes)[-1], height = 15, width = 10, directory = heatmapdir, cutrow = 2, gap_col = c(3),fileprefix = fileprefix, suffix = "_top100genes.pdf", show_row = TRUE)
genheatmap(top100genes, colnames(top100genes)[-1], height = 15, width = 10, directory = heatmapdir, cutrow = 2, gap_col = c(3),fileprefix = fileprefix, suffix = "_top100genes_nolabels.pdf", show_row = FALSE)

# Display top 400 Genes
top400genes <- sigDEcounts %>% head(n = 400)
genheatmap(top400genes, colnames(top400genes)[-1], height = 55, width = 10, directory = heatmapdir, cutrow = 2, gap_col = c(3),fileprefix = fileprefix, suffix = "_top400genes.pdf", show_row = TRUE)
genheatmap(top400genes, colnames(top400genes)[-1], height = 55, width = 10, directory = heatmapdir, cutrow = 2, gap_col = c(3),fileprefix = fileprefix, suffix = "_top400genes_nolabels.pdf", show_row = FALSE)
```
...
#### 2.4.2.2 Set Pathways of Interest
